...
$failUrl         = $hosturl."/local-web/def/unsuccesfull.php";
$successUrl      = $hosturl."/local-web/def/succesfull.php";
$payAction       = $hosturl."/local-web/def/parampos/soap.php";
